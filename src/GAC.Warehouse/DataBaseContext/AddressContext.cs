...
namespace GAC.Warehouse.DataBaseContext
{
  ...
  public class AddressContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<Address>().HasData(new Address() { ID = 1, City = "Bangalore", Country = "India", VendorID = 1, State = "Karnataka", Street = "Triveni Road", ZipCode = "560021" },
        new Address() { ID = 2, City = "Hyderabad", Country = "India", VendorID = 2, State = "Andhra", Street = "Cord Road", ZipCode = "121212" });
    }
